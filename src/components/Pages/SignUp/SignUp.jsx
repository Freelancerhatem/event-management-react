...
const SignUp = () => {
    ...
    return (
        <div>
            ...
            <div>                
                <div data-aos='fade-down' data-aos-duration="500" className="relative mt-32 mx-auto flex w-72 md:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
